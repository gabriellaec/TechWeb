...
<div class="topnav">
 ...
 `  <div class="ordenar"><form action="${pageContext.request.contextPath}/Ordena"  method="post">
	     <input type="radio"  name="ordenar" value="alfabetica">
		  <label for="alfabetica">Alfabética</label><br>  
		  <input type="radio"  name="ordenar" value="prazo">
		  <label for="prazo">Data de entrega</label><br><br>
...
<fmt:formatDate
 ...
 <td>
  <form action="${pageContext.request.contextPath}/Remove" method='post'>
   ...
   <td>
  <form action="${pageContext.request.contextPath}/Atualiza" method='get'>
            <input type='hidden' name='id'  value='${tarefas.id}' >
